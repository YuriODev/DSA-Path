...
| **Day** | **Sprint**                                                        | **Topic**                                            | **Objectives**                                                                                                                                                                 | **Date Completed** | **Completed** |
|---------|-------------------------------------------------------------------|------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------|---------------|
| **Day 1**  | Fundamentals of Algorithms & Complexity               | [Introduction to Algorithms & Time Complexity Basics](./notebooks/day_01_intro_time_complexity.ipynb)  | - Define what an algorithm is<br>- Learn basic time complexity $(O(n)$, $O(\log n))$                                                                                               | Feb 13, 2025  | ✅  |
| **Day 2**  | Fundamentals of Algorithms & Complexity               | [Big-O Notation & Time Complexity](./notebooks/day_02_algorithm_complexity.ipynb);<br><br>Day 2: [Solutions](./solutions/day_02_solutions.md)                    | - Master Big-O notation<br>- Understand trade-offs in time complexity                                                                                                         | Feb 14, 2025  | ✅  |
| **Day 3**  | Basic Data Structures                                  | [Arrays and Their Operations, Space Complexity](./notebooks/day_03_arrays_operations.ipynb)<br><br>Day 3: [Solutions](./solutions/day_03_solutions.md)                          | - Understand array data structures<br>- Practice insertion, deletion, and search                                                                                               | Feb 15, 2025  | ✅  |
| **Day 4**  | Basic Data Structures                                  | [Python Lists and Set methods complexity comparison](./notebooks/day_04_lists_vs_sets.ipynb)<br><br>Day 4: [Solutions](./solutions/day_04_solutions.md)                          | - Understand the set vs list data structures<br>- Use sets for fast membership tests and duplicate elimination.                                                                           | Feb 19, 2025  |  ✅ |
| **Day 5**  | Extended Algorithmic Techniques                        | Moving Average & Two Pointers Method                 | - Recap algorithm basics<br>- Implement moving average and two pointers technique                                                                                              | Feb 20, 2025  | ❌  |
| **Day 6**  | Extended Algorithmic Techniques                        | Sliding Window & Prefix Sum Techniques               | - Learn sliding window technique<br>- Understand and implement prefix sum arrays for efficient range queries                                                                     | Feb 21, 2025  | ❌  |
| **Day 7**  | Basic Data Structures                                  | Linked Lists, Stacks, & Queues                         | - Learn pointer-based structures<br>- Master LIFO (stacks) and FIFO (queues) operations                                                                                          | Feb 22, 2025  | ❌  |
| **Day 8**  | Recursion & Divide & Conquer                           | Recursion Fundamentals & Basic Examples              | - Understand recursion fundamentals<br>- Identify base and recursive cases                                                                                                     | Feb 23, 2025  | ❌  |
| **Day 9**  | Recursion & Divide & Conquer                           | Recursion Trees & Binary Search                      | - Learn the divide & conquer strategy<br>- Implement binary search recursively                                                                                               | Feb 24, 2025  | ❌  |
| **Day 10** | Sorting Algorithms                                     | Elementary Sorting: Bubble, Selection, & Insertion Sorts| - Implement basic sorting algorithms<br>- Compare performance characteristics                                                                                                | Feb 25, 2025  | ❌  |
| **Day 11** | Sorting Algorithms                                     | Advanced Sorting: Merge, Quick, & Counting Sort      | - Understand and implement advanced sorting techniques<br>- Analyze stability and in-place considerations                                                                       | Feb 26, 2025  | ❌  |
| **Day 12** | Hashing Techniques                                     | Hash Functions & Collision Resolution                | - Understand the principles behind hash functions<br>- Learn methods for collision resolution                                                                                  | Feb 27, 2025  | ❌  |
| **Day 13** | Trees & Binary Search Trees                            | Tree Structures: Basics & Binary Trees               | - Understand tree structures<br>- Implement binary trees and basic traversals                                                                                                  | Feb 28, 2025  | ❌  |
| **Day 14** | Trees & Binary Search Trees                            | Binary Search Trees & Advanced Traversals            | - Master BST operations (insertion, deletion, search)<br>- Explore advanced traversal strategies                                                                                 | Mar 1, 2025  | ❌  |
| **Day 15** | DSA-pathAdvanced Trees & Heaps                         | Self-Balancing Trees & B-Trees                       | - Understand self-balancing mechanisms<br>- Explore AVL, Red-Black trees, and B-trees for disk-based data structures                                                             | Mar 2, 2025  | ❌  |
| **Day 16** | DSA-pathAdvanced Trees & Heaps                         | Heaps, Priority Queues, & Heap Sort                  | - Learn heap properties and priority queue operations<br>- Implement heap sort                                                                                                 | Mar 3, 2025  | ❌  |
| **Day 17** | Graphs – Fundamentals & Traversal                      | Graph Representations                                | - Understand graph definitions and representations<br>- Implement adjacency lists and matrices                                                                                 | Mar 4, 2025   | ❌  |
| **Day 18** | Graphs – Fundamentals & Traversal                      | Graph Traversal: DFS & BFS                           | - Implement depth-first and breadth-first search algorithms<br>- Compare recursive and iterative approaches                                                                    | Mar 5, 2025   | ❌  |
| **Day 19** | Graph Algorithms – Shortest Paths                      | Dijkstra's & Bellman-Ford Algorithms                 | - Implement shortest path algorithms<br>- Analyze strengths and limitations of each                                                                                            | Mar 6, 2025   | ❌  |
| **Day 20** | Graph Algorithms – Shortest Paths                      | A* Algorithm & Heuristic Search                      | - Understand heuristic functions in pathfinding<br>- Implement A* search for grid-based problems                                                                                   | Mar 7, 2025   | ❌  |
| **Day 21** | DSA-pathAdvanced Graph Algorithms                      | Minimum Spanning Trees & Topological Sorting         | - Implement MST algorithms and understand their applications<br>- Learn topological sorting for dependency resolution                                                             | Mar 8, 2025   | ❌  |
| **Day 22** | DSA-pathAdvanced Graph Algorithms                      | Strongly Connected Components & Network Flow         | - Explore algorithms for detecting SCC and modeling network flows<br>- Apply these techniques to resource allocation problems                                                    | Mar 9, 2025   | ❌  |
| **Day 23** | Greedy & Dynamic Programming                           | Greedy Algorithms & Their Proofs                     | - Understand the greedy strategy and its limitations<br>- Prove correctness for selected greedy algorithms                                                                        | Mar 10, 2025   | ❌  |
| **Day 24** | Greedy & Dynamic Programming                           | Dynamic Programming Fundamentals                   | - Learn DP concepts and techniques<br>- Distinguish between memoization and tabulation approaches                                                                                  | Mar 11, 2025   | ❌  |
| **Day 25** | String Algorithms & Pattern Matching                   | String Search Techniques: Naive, KMP, & Rabin-Karp     | - Compare various string search methods<br>- Implement efficient pattern matching algorithms                                                                                    | Mar 12, 2025   | ❌  |
| **Day 26** | String Algorithms & Pattern Matching                   | Trie Structures & Suffix Trees/Arrays                | - Learn advanced data structures for string processing<br>- Build and query tries and suffix structures                                                                         | Mar 13, 2025  | ❌  |
| **Day 27** | Interview Simulation & Practice                        | Mock Interview Sessions & Problem Drills             | - Simulate technical interviews<br>- Practice on-the-fly problem solving and effective communication                                                                             | Mar 14, 2025  | ❌  |
| **Day 28** | Interview Simulation & Practice                        | Communication & Iterative Feedback                   | - Refine communication of technical solutions<br>- Incorporate iterative feedback to improve problem-solving                                                                      | Mar 15, 2025  | ❌  |
| **Day 29** | Advanced Problem-Solving Techniques                    | Backtracking Algorithms & Applications               | - Understand backtracking fundamentals<br>- Solve permutation, combination, and puzzle problems using backtracking                                                                | Mar 16, 2025  | ❌  |
| **Day 30** | Advanced Problem-Solving Techniques                    | Bit Manipulation Techniques                          | - Master bit-level operations<br>- Apply bit manipulation for optimization problems and state compression                                                                       | Mar 17, 2025  | ❌  |
| **Day 31** | Advanced Problem-Solving Techniques                    | Union-Find / Disjoint Set Data Structure             | - Learn the Union-Find structure for efficient connectivity queries<br>- Apply it to cycle detection and clustering in graphs                                                     | Mar 18, 2025  | ❌  |
| **Day 32** | Advanced Problem-Solving Techniques                    | Segment Trees & Binary Indexed Trees                 | - Understand advanced range query data structures<br>- Implement segment trees and BITs for efficient range updates and queries                                                   | Mar 19, 2025  | ❌  |
| **Day 33** | System Design & OOP Concepts                           | Introduction to System Design & Scalability          | - Grasp basic system design principles<br>- Learn how to scale systems effectively                                                                                                | Mar 20, 2025  | ❌  |
| **Day 34** | System Design & OOP Concepts                           | Object-Oriented Design & Design Patterns             | - Understand core OOP principles<br>- Learn common design patterns for robust software design                                                                                     | Mar 21, 2025  | ❌  |
...
- **scripts**: Contains the Python scripts for the course.
- **images**: Contains the images for the course.
- **README.md**: The main README file for the course.
